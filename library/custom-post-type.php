...
function pj_portfolio() {
	...
	'all_items' => __('All Portfolio Items', 'bonestheme'), /* the all items menu item */
	'add_new' => __('Add New', 'bonestheme'), /* The add new menu item */
	'add_new_item' => __('Add New Portfolio Item', 'bonestheme'), /* Add New Display Title */
	'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
	'edit_item' => __('Edit Portfolio Item', 'bonestheme'), /* Edit Display Title */
	...
	'search_items' => __('Search Portfolio Item', 'bonestheme'), /* Search Custom Type Title */
	'not_found' =>  __('Nothing found in the Database.', 'bonestheme'), /* This displays if there are no entries yet */
	'not_found_in_trash' => __('Nothing found in Trash', 'bonestheme'), /* This displays if there is nothing in the trash */
	'parent_item_colon' => ''
		), /* end of arrays */
		'description' => __( 'Examples of completed projects', 'bonestheme' ), /* Custom Type Description */
		'public' => true,
